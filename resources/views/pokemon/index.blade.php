...
@can('create', App\Models\Pokemon::class)
    ...
    <a href="{{url('pokemon/create')}}" class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">New Pokemon</a>
    </div>
    </div>
@endcan
...
@foreach($pokemon as $entity)
        ...
        @else
            <span class="text-sm text-gray-500 dark:text-gray-400">No Trainer</span>
        @endif
